...
const BALI_TOURS = [
  ...
  },
  {
    ...
    type: "пляжный",
    tag: "Популярный",
    img: "https://cdn.poehali.dev/projects/e3c4122f-0f20-43fa-9a94-a1e79f8d750a/bucket/6416e634-444b-4a2e-922f-2f97bdd8d355.jpg",
  ...
  {
    id: 4,
    title: "2 недели на Бали",
    subtitle: "Остров Бали",
    duration: 13,
    price: 95000,
    type: "пляжный",
    tag: "",
    img: "https://cdn.poehali.dev/projects/e3c4122f-0f20-43fa-9a94-a1e79f8d750a/bucket/88322a75-01bb-4081-9004-fb9955fadc26.jpg",
    video: null,
    description: "Чем заняться в эти 2 недели:\n\nокунуться в атмосферу Убуда, города с самой сильной энергетикой на планете, погулять по рисовым террасам\nсделать сотни селфи на фоне всемирно известных локаций\nкаждый день встречать рассветы и провожать закаты\nобязательно сделать традиционный балийский массаж, а лучше взять курс - кто делал, тот знает, что это магия\nсъездить в модный beach club c классной музыкой\nкаждый вечер ужинать в новых интересных местах\n\nА можно выбросить этот список из головы и каждый день после завтрака уютно устраиваться на шезлонге и просто слушать океан, запретив себе даже думать о работе.",
    highlights: ["Убуд и рисовые террасы", "Балийский массаж", "Beach club", "Закаты у океана"],
  },
  {
    id: 3,
    title: "Ayodya Resort Bali 5*",
    subtitle: "Остров Бали",
    duration: 13,
    price: 145000,
    type: "пляжный",
    tag: "",
    img: "https://cdn.poehali.dev/projects/e3c4122f-0f20-43fa-9a94-a1e79f8d750a/bucket/9e98d80f-a725-41a3-89e0-1f4d31a52549.jpg",
