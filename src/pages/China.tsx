...
const CHINA_TOURS = [
  {
    id: 1,
    title: "Хайнань — Санья",
    subtitle: "Тропический курорт Китая",
    duration: 7,
    price: 65897,
    type: "пляжный",
    tag: "Хит сезона",
    img: "https://cdn.poehali.dev/projects/e3c4122f-0f20-43fa-9a94-a1e79f8d750a/bucket/9867595d-0b65-419f-9c55-08ea10189184.jpg",
    description: "Отдых на берегу Южно-Китайского моря. Белоснежные пляжи, тёплое море круглый год, экзотическая природа и лечебные курорты острова.",
    highlights: ["Пляж Ялунвань", "Горячие источники", "Буддийский парк", "Тропический лес"],
  },
  {
    id: 2,
    title: "Пекин — Великая стена",
    subtitle: "Столица и её легенды",
    duration: 8,
    price: 89000,
    type: "экскурсионный",
    tag: "Популярный",
    img: "https://images.unsplash.com/photo-1508804185872-d7badad00f7d?w=800&q=80",
    description: "Погрузитесь в историю древней империи: Запретный город, Великая Китайская стена, площадь Тяньаньмэнь и колоритные хутуны.",
    highlights: ["Великая стена", "Запретный город", "Храм Неба", "Летний дворец"],
  },
  {
    id: 3,
    title: "Шанхай — мегаполис будущего",
    subtitle: "Небоскрёбы и старые улочки",
    duration: 6,
    price: 78500,
    type: "городской",
    tag: "Новинка",
    img: "https://images.unsplash.com/photo-1537944434965-cf4679d1a598?w=800&q=80",
    description: "Контраст старого и нового: набережная Бунд, небоскрёбы Пудуна, французский квартал и аутентичные шанхайские переулки.",
    highlights: ["Набережная Бунд", "Башня Шанхай", "Старый город", "Квартал Тяньцзыфан"],
  },
  {
    id: 4,
