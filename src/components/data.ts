...
export const PEOPLE_IMG = "https://cdn.poehali.dev/projects/e3c4122f-0f20-43fa-9a94-a1e79f8d750a/bucket/865fdf51-f0fa-4104-99c5-5a810c534088.jpg";
...
export const ROUTES = [
  ...
  { id: 3, title: "Вьетнам — Камрань", type: "пляжный", duration: 14, price: 115000, difficulty: "средний", img: "https://cdn.poehali.dev/projects/e3c4122f-0f20-43fa-9a94-a1e79f8d750a/bucket/2bcc5874-6a20-44a4-9b7a-906ff86e3b8d.jpg", description: "Насладитесь отдыхом в Камрани — курорте, который покоряет своими широкими пляжами, тёплым морем круглый год и уютной атмосферой, позволяющей полностью расслабиться и забыть о повседневных заботах", tag: "Новинка" },
