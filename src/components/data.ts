...
export const ROUTES = [
  ...
  { id: 4, title: "Таиланд — Пхукет", type: "пляжный", duration: 7, price: 195000, difficulty: "лёгкий", img: RESORT_IMG, description: "Пхукет — жемчужина Таиланда, где белоснежные пляжи, кристально чистое море и тропическая природа создают идеальные условия для незабываемого отдыха в любое время года", tag: "Эксклюзив" },
  { id: 5, title: "Сейшельские острова", type: "пляжный", duration: 12, price: 78000, difficulty: "средний", img: "https://cdn.poehali.dev/projects/e3c4122f-0f20-43fa-9a94-a1e79f8d750a/bucket/e8bcdc7f-fa9f-4568-a495-0248667abcb9.jpg", description: "Сейшелы — это место, где время замедляется, а каждый день наполнен красотой природы, спокойствием океана и яркими впечатлениями от отдыха мирового уровня", tag: "" },
  { id: 6, title: "Япония", type: "экскурсионный", duration: 8, price: 64000, difficulty: "лёгкий", img: "https://cdn.poehali.dev/projects/e3c4122f-0f20-43fa-9a94-a1e79f8d750a/bucket/568b7ffd-fa7c-4a8b-b777-14dac3bf2bf7.jpg", description: "От величественных храмов и цветущей сакуры до футуристических мегаполисов — путешествие по Японии подарит уникальный опыт, наполненный красотой, вдохновением и яркими открытиями", tag: "" },
];
