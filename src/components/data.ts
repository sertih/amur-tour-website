...
export const REVIEWS = [
  ...
  { name: "Александр Кузьмичев", rating: 5, text: "Решился съездить в Таиланд впервые. Обратился в Авиа Нэкст Тур, менеджер Анна подобрала отличный вариант отдыха. Всё прошло гладко, впечатления незабываемые. Сервис на высоте, рекомендую компанию друзьям и знакомым.", date: "Декабрь 2025", avatar: "А" },
